...
fun SignInScreen(
    ...
    Box(
        ...
        Column( horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center, modifier = Modifier.fillMaxSize()) {
            ChangingTextScreen()
            Image(painter = painterResource(id = R.drawable.waterdrop), contentDescription = "logo", modifier = Modifier.height(36.dp))
            ...
            Button(onClick = onSignInClick, modifier = Modifier.fillMaxWidth()) {
                Row(
                    ...
                    Image(painter = painterResource(id = R.drawable.google), contentDescription ="google-logo",modifier = Modifier
                        .padding(4.dp)
                        .height(24.dp), )
                    Spacer(modifier = Modifier.padding(16.dp))
                    Text("Sign In", fontWeight = androidx.compose.ui.text.font.FontWeight.Bold, fontSize = 18.sp)
